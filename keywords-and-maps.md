...
Например, [библиотека Экто](https://github.com/elixir-lang/ecto) использует эти особенности для предоставления элегантного DSL для написания запросов к базе данных:
...
Эти характеристики являются причиной, по которой ключевые списки стали стандартным механизмом передачи опций в функции Эликсира. В главе [**«Конструкции ветвления»**](/docs/case-cond-and-if.html), при обсуждении макроса `if/2` мы упоминали, что поддерживается следующий синтаксис:
