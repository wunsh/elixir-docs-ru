...
Во всех примерах выше, мы использовали бинарные последовательности для записи файлов. В главе [«Бинарные последовательности, строки и списки символов»](/docs/binaries-strings-and-char-lists.html) мы упоминали, как строки формируются из байтов, в то время как списки символов – это списки с кодами Юникода.
