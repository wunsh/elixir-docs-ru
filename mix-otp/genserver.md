...
Для того, чтобы исправить эту ошибку, нам нужно зарегистрировать монитор, когда корзина создается. Как только мы установим монитор, реестр будет получать уведомления каждый раз, когда корзина заканчивает работу, позволяющие очистить словарь.
